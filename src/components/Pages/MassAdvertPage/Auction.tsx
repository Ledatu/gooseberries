        ...
        },
        {
            placeholder: (
                ...
                >
                    ...
                    <HelpMark content="Расчет произведен на основе статистики вашего артикула по конверсии из показа в заказ за последние 7 дней. Показывает прогнозируемый ДРР для вашего артикула при продвижении с такой ставкой." />
                </div>
            ),
            name: 'calcDrr',
