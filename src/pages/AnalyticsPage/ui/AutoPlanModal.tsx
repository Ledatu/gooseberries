...
interface AutoPlanModalProps {
    ...
    graphModalTitle: string;
    setGraphModalTitle: Dispatch<SetStateAction<string>>;
    planModalPlanValueValid: boolean;
    planModalOpenFromEntity: string;
    planModalPlanValue: any;
    setPlanModalPlanValueValid: Dispatch<SetStateAction<boolean>>;
    getPlanDay: any;
    planModalKey: any;
...
export const AutoPlanModal: FC<AutoPlanModalProps> = ({
    planModalOpen,
    setPlanModalOpen,
    setGraphModalTitle,
    graphModalTitle,
