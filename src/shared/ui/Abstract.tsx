    ...
    return (
        ...
        >
            ...
            >
                                    ...
                                    >
                                        ...
                                        <Button
                                            ...
                                            disabled={
                                                ...
                                                doc?.adverts?.[selectValue[0]]?.[advertId]?.type !=
                                                    8
                                            }
                                            onClick={async () => {
                                                const params: any = {
                ...
                <Modal open={showArtStatsModalOpen} onClose={() => setShowArtStatsModalOpen(false)}>
                    <motion.div
                                ...
                                renderControl={({triggerProps: {onClick, onKeyDown}}) => {
                                    return (
                                        ...
                                        >
                                            ...
                                            >
                                                <Text variant="display-2" style={{marginBottom: 8}}>
